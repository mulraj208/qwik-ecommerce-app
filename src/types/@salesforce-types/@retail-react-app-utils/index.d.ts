...
declare module '@salesforce/retail-react-app/app/utils/test-utils' {
  ...
  export const TestProviders: (props: {children: React.ReactNode, locale?: {id: string}, messages?: Record<string, unknown>, appConfig?: Record<string, unknown>, siteAlias?: string, isGuest?: boolean, bypassAuth?: boolean}) => React.ReactElement

  export function renderWithProviders(children: React.ReactNode, options?: Record<string, unknown>): { container: string | Element } & Record<string, unknown>

  export const createPathWithDefaults: (path: string) => string

  export const withPageProvider: (Component: React.ReactNode, options: Record<string, unknown>) => React.ReactNode
}
